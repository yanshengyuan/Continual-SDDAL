...
# ==========================================
# SDDAL_replay.sh — HRR-CL variant of SDDAL.sh
#
...
#
# Usage:
#   bash SDDAL_replay.sh <beamshape> <lr> <initial_size> <fix_init?> <init_only?> <start_round> <end_round> <gpu> <scanner_batch_size> <retrain_frequency> <scan_only?> <seed> <init_seed> <buffer_size>
#
# Argument meaning:
#   fix_init:
...
# Examples:
#
# 1) HRR-CL full pipeline  -> writes to Design_rec_1_500/
#    bash SDDAL_replay.sh rec 0.0002 100 true false 1 200 0 5 1 false 1 123 500
#
# 2) Init-only             -> writes to Design_rec_1_500/
#    bash SDDAL_replay.sh rec 0.0002 100 true true 1 200 0 5 1 false 1 123 500
#
# 3) Resume HRR-CL pipeline
#    bash SDDAL_replay.sh rec 0.0002 100 true false 41 200 0 5 1 false 1 123 500
#
# ==========================================
...
exp_path="Design_${beamshape}_${seed}_${buffer_size}"
...
# has the '_buffersize' suffix so they are kept separate.
# =========================================================
