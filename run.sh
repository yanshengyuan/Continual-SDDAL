...
python3 train_unet.py --data rec_dataset --epochs 15 --batch_size 2 --gpu 0 --lr 0.0002 --step_size 2 --seed 123 --pth_name rec.pth.tar
And evaluate:
...
Full-scene fine-grained experimental design:
nohup bash Neural_Experimental_Design.sh rec 0.0002 1 400 0 5 100 1281 1 false true > AED_rec_full_scene_fine.txt 2>&1 &

Full-scene coarse-grained experimental design:
nohup bash Neural_Experimental_Design.sh rec 0.0002 1 100 0 20 100 1281 1 false true > AED_rec_full_scene_coarse.txt 2>&1 &